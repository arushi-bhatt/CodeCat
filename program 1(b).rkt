...
#lang racket
(printf   "*(1(b))__________Multiplying numbers upto 10__________* \n")
...
(for ([i (in-range  0 10)]) 
          ;random nos. within range of 90-100 will be generated
             (define-values (p q) (values (random  90 100) (random 90 100)))
          ;print the nos.
             (printf "(~a) ~a * ~a \n"(+ i 1) p q)
