...
;Program 5(c)
;Multiplying numbers above and below 50


#lang racket
(printf   "*(5(c))__________Multiplying numbers above and below 50__________* \n")
...
(for ([i (in-range  0 10)]) 
          ;random nos. within range of 34-76 will be generated
             (define-values (p q) (values (random 34 76) (random 34 76)))
          ;print the nos.
             (printf "(~a) ~a * ~a \n"(+ i 1) p q)
