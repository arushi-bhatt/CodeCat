...
;Program 3(b)
;Multiplying numbers above and below 100


#lang racket
(printf   "*(3(b))__________Multiplying numbers above and below 100__________* \n")
...
(for ([i (in-range  0 10)]) 
          ;random nos. within range of 80-130 will be generated
             (define-values (p q) (values (random 80 130) (random 80 130)))
          ;print the nos.
             (printf "(~a) ~a * ~a \n"(+ i 1) p q)
