...
#lang racket
(printf   "*(1(a))__________Multiplying numbers upto 10__________* \n")
...
(for ([i (in-range  0 10)]) 
          ;random nos. within range of 1-10 will be generated
             (define-values (p q) (values (random 1 11) (random 1 11)))
          ;print the nos.
             (printf "(~a) ~a * ~a \n"(+ i 1) p q)
