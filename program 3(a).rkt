...
;Program 3(a)
;Multiplying numbers above below and 10


#lang racket
(printf   "*(3(a))__________Multiplying numbers above and below 10__________* \n")
...
(for ([i (in-range  0 10)]) 
          ;random nos. within range of 1-30 will be generated
             (define-values (p q) (values (random 1 30) (random 1 30)))
          ;print the nos.
             (printf "(~a) ~a * ~a \n"(+ i 1) p q)
