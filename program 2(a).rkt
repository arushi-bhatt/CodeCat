...
;Program 2(a)
;Multiplying numbers in teens


#lang racket
(printf   "*(2(a))__________Multiplying numbers in teens__________* \n")
...
(for ([i (in-range  0 10)]) 
          ;random nos. within range of 10-20 will be generated
             (define-values (p q) (values (random 10 20) (random 10 20)))
          ;print the nos.
             (printf "(~a) ~a * ~a \n"(+ i 1) p q)
